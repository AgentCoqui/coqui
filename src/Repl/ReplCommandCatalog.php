...
final class ReplCommandCatalog
{
    ...
    public static function all(): array
    {
        return self::$commands ??= [
            ...
            new ReplCommandSpec('/backstory', '/backstory [generate|failed]', 'Show backstory status, generated content, and source breakdowns for the active profile.', firstArguments: ['generate', 'failed'], section: 'Context & Inspection'),
            ...
            new ReplCommandSpec('/schedules', '/schedules [action]', 'Inspect schedules. Enable|disable|delete|trigger actions are advanced automation controls.', firstArguments: ['enable', 'disable', 'delete', 'trigger'], section: 'Advanced Automation & Operator Controls'),
            ...
            new ReplCommandSpec('/webhooks', '/webhooks', 'List webhook subscriptions. Delivery and subscription lifecycle are advanced automation concerns.', section: 'Advanced Automation & Operator Controls'),

...
final class ReplCommandCatalog
{
    ...
    public static function all(): array
    {
        return self::$commands ??= [
            ...
            new ReplCommandSpec('/channels', '/channels [action]', 'Inspect channels or run drivers, status, add, set, enable, disable, delete, links, link, unlink, or deliveries for operator control.', firstArguments: ['drivers', 'status', 'show', 'health', 'add', 'set', 'enable', 'disable', 'delete', 'remove', 'links', 'link', 'unlink', 'deliveries'], section: 'Advanced Automation & Operator Controls'),

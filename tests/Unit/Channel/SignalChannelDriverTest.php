...
test('signal runtime accepts direct envelope json lines', function (): void {
    ...
    try {
        ...
        expect($events[0]['remote_user_key'])->toBe('+18455420755');
...
test('signal runtime builds json-rpc send requests for outbound deliveries', function (): void {
    ...
    try {
        ...
        $recipientRequest = json_decode((string) $buildSendRequest->invoke($runtime, 'send-1', 'hello', '+18455420755', null), true, 512, JSON_THROW_ON_ERROR);

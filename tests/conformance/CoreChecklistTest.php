...
$rows = [
    ...
    'CORE-22: artifact_required is profile-gated; a def requiring it on a no-artifacts instance is rejected 422 at loop creation',
    ...
    'CORE-30: extension is a declared gradient; host toolkits are declared in InstanceInfo; profiles are a closed set',
    'CORE-31: the mcp profile pins the integration contract (namespacing/gating/budget/trust/transports); transports are a closed set',
    ...
    'CORE-35: InstanceInfo MAY carry per-profile versions (semver); docs content is impl-defined',
    ...
    'CORE-39: InstanceInfo.profiles is an open string set; discovery MUST NOT reject an unknown profile',
    ...
    'CORE-47: x-profile operations map cleanly across both bindings (HTTP + in_process)',
